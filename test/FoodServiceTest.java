...
public class FoodServiceTest {
    ...
    private static Stream<OrderFactory.OrderType> orderTypeProvider() {
        return Stream.of(
                OrderFactory.OrderType.delivery_order,
                OrderFactory.OrderType.dine_in_order,
                OrderFactory.OrderType.take_away_order
        );
    }
    ...
    void testMakeOrderParameterized(OrderFactory.OrderType orderType) {
    ...
    @MethodSource("orderTypeProvider")
    void testProcessOrderParameterized(OrderFactory.OrderType orderType) {
        OrderFactory factory = new OrderFactory();
        KitchenService kitchen = new KitchenService();
        PaymentService payment = new PaymentService();
        FoodService foodService = new FoodService(factory, kitchen, payment);
